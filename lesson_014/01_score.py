...
#   «34» – сумма 3+4=7
#   «-4» - сумма 0+4=4
# То есть для игры «X4/34-4» сумма очков равна 20+15+7+4=46
#
...
# TODO 1) пропускает результат с двумя непарнымы фреймами до и после страйка: 2-244X-  =  32 points
#  2) позволяет делать более 10 очков во фрейме: 56, 57 и т.п.
